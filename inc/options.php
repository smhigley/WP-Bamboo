...
function bamboo_admin_init(){
    ...
    add_settings_field(
        'bamboo_google_analytics_id',      // id
        'Google Analytics ID',              // setting title
        'bamboo_get_analytics_id',    // display callback
        'general',                 // settings page
...
function bamboo_get_analytics_id() {
    // get option 'boss_email' value from the database
    $options = get_option( 'bamboo_options');
        $value = $options['bamboo_google_analytics_id']

    // echo the field
    ?>
<input id='bamboo_google_analytics_id' name='bamboo_options[bamboo_google_analytics_id]'
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                ...
                <tr valign="top"><th scope="row"><?php _e( 'Phone Number', 'mboy' ); ?></th>
                    <td>
                        <input id="bamboo_theme_options[phone]" class="regular-text" type="text" name="bamboo_theme_options[phone]" value="<?php esc_attr_e( $options['phone'] ); ?>" />
                        <label class="description" for="bamboo_theme_options[phone]"><?php _e( 'Phone Number', 'mboy' ); ?></label>
                    </td>
                </tr>
                ...
                <tr valign="top"><th scope="row"><?php _e( 'Email', 'mboy' ); ?></th>
                    <td>
                        ...
                        <label class="description" for="bamboo_theme_options[email]"><?php _e( 'Email address', 'mboy' ); ?></label>
                    </td>
                </tr>
                ...
                <tr valign="top"><th scope="row"><?php _e( 'Twitter', 'mboy' ); ?></th>
                    <td>
                        ...
                        <label class="description" for="bamboo_theme_options[twitter]"><?php _e( 'Twitter profile URL', 'mboy' ); ?></label>
                    </td>
                </tr>
                ...
                <tr valign="top"><th scope="row"><?php _e( 'LinkedIn', 'mboy' ); ?></th>
                    <td>
                        ...
                        <label class="description" for="bamboo_theme_options[linkedin]"><?php _e( 'LinkedIn profile URL', 'mboy' ); ?></label>
                    </td>
                </tr>
                ...
                <tr valign="top"><th scope="row"><?php _e( 'Google Plus', 'mboy' ); ?></th>
                    <td>
                        ...
                        <label class="description" for="bamboo_theme_options[gplus]"><?php _e( 'Google Plus profile URL', 'mboy' ); ?></label>
                    </td>
                </tr>
